...
terme2=cp(T0,T_fin,a0ch4,a1ch4,a2ch4,a3ch4,a4ch4,b0ch4,b1ch4,b2ch4,b3ch4,b4ch4)*(T_fin-T0)+vO2*cp(T0,TAin,a0o2,a1o2,a2o2,a3o2,a4o2,b0o2,b1o2,b2o2,b3o2,b4o2)*(TAin-T0)+v_N2*cp(T0,TAin,a0n2,a1n2,a2n2,a3n2,a4n2,b0n2,b1n2,b2n2,b3n2,b4n2)*(TAin-T0);
Tcc=1000;
error=1;

terme1=(h_fch4-(v_co2*h_fCO2+vH2O*h_fH2O));
%     Co2out=v_co2*cp(298,1500,a0co2,a1co2,a2co2,a3co2,a4co2,b0co2,b1co2,b2co2,b3co2,b4co2)*(Tcc-298)
%     H2Oout=vH2O*cp(298,1500,a0h2o,a1h2o,a2h2o,a3h2o,a4h2o,b0h2o,b1h2o,b2h2o,b3h2o,b4h2o)*(Tcc-298)
%     n2out=v_N2*cp(T0,1500,a0n2,a1n2,a2n2,a3n2,a4n2,b0n2,b1n2,b2n2,b3n2,b4n2)*(Tcc-T0)
...
while (error>10^-15)
    Tccold=Tcc;
    Tcc=T0+(terme1+terme2)/(v_co2*cp(T0,Tcc,a0co2,a1co2,a2co2,a3co2,a4co2,b0co2,b1co2,b2co2,b3co2,b4co2)+vH2O*cp(T0,Tcc,a0h2o,a1h2o,a2h2o,a3h2o,a4h2o,b0h2o,b1h2o,b2h2o,b3h2o,b4h2o)+v_N2*cp(T0,Tcc,a0n2,a1n2,a2n2,a3n2,a4n2,b0n2,b1n2,b2n2,b3n2,b4n2));
